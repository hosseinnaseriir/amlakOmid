          ...
          <div className="d-flex justify-content-center  align-items-center">
              <Form className='mb-5'>
                  <div className='signIn-form d-flex flex-wrap justify-content-between '>
                      <Form.Control onChange={nameHandeller} className="w-45 shadow-es py-2 my-4 border-0" type="text" placeholder="نام" />
                      <Form.Control onChange={lastNameHandeller} className="w-45 shadow-es py-2 my-4 border-0" type="text" placeholder="نام خانوادگی" />
                  
                      <Form.Control onChange={phoneHandeller} className="w-45 shadow-es py-2 my-4 border-0" type="text" placeholder="شماره تماس" />
                      <Form.Control onChange={idHandeller} className="w-45 shadow-es py-2 my-4 border-0" type="text" placeholder="کد ملی" />

                      <Form.Control onChange={addressHandeller} className="w-100 shadow-es py-2 my-4 border-0" type="text" placeholder="آدرس" />
                      <Form.Control onChange={pichandeller} className="w-45 shadow-es py-2 my-4 border-0" type="file" placeholder="افزودن عکس کارت ملی" />

                  </div>
         
                  <button  onClick={(e)=>BtnHandeller(e)} className="btn fw-bold btn btn-es mb-lg-0 mt-lg-0 mt-4 mb-4 px-5  " href="#">ثبت نام </button>
